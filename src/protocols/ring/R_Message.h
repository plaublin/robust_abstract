...
const short R_MESSAGE_READ_ONLY = 1;
...
const int R_Max_message_size = 60000;
...
public:
	...
	short extra() const;
	// Effects: returns the extra part of the message...
...
inline short R_Message::extra() const
{
	return msg->extra;
}
...
inline char *R_Message::contents() const
{
	return (char *)msg;
}
