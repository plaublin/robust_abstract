...
class C_Node
{
	public:
		...
		bool verify_auth_from_client(int n_id, int cid, char *s, unsigned l, char *dest,
	...
	protected:
		...
		pthread_t timeouts_handler_thread;
...
inline enum protocols_e C_Node::instance_id() const
{
    return chain;
}

inline enum protocols_e C_Node::next_instance_id() const
{
    return aardvark;
}
