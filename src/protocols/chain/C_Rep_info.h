...
public:
  ...
  char *
  new_reply(int pid, int &size, Seqno seq);
  // Requires: "pid" is a valid principal identifier.
  ...
  Seqno sent_seqno(int dest_pid) const;
  // Returns the seqno of the given reply
...
inline C_Reply_rep*
C_Rep_info::reply_rep(int pid)
{
  return (C_Reply_rep *)(reps[pid]->contents());
}
...
inline Seqno C_Rep_info::sent_seqno(int pid) const
{
	return reps[pid]->seqno();
}
#endif // _C_Rep_info_h
