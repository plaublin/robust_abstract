...
static inline O_Time currentQ_Time() {
  O_Time t;
...
static inline O_Time zeroQ_Time() {  
  O_Time t;
  t.tv_sec = 0;
  t.tv_usec = 0
  return t; 
...
static inline long long diffQ_Time(O_Time t1, O_Time t2) {
  // t1-t2 in microseconds.
  return (((unsigned long long)(t1.tv_sec-t2.tv_sec)) << 20) + (t1.tv_usec-t2.tv_usec);
}

static inline bool lessThanQ_Time(O_Time t1, O_Time t2) {
...
static inline O_Time currentQ_Time() { return O_rdtsc(); }

static inline O_Time zeroQ_Time() { return 0; }
